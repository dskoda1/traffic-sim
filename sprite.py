...
class CarSprite(pygame.sprite.Sprite):
    ...
    def __init__(self, image, position):
        ...
        surface = pygame.transform.scale(pygame.image.load(image), (30, 20))
        self.src_image = pygame.transform.rotate(surface, 90)
...
car = CarSprite('img/car-top.png', rect.center)
